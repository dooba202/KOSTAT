...
public class SimpleSelect3Test {
	...
	public static void setUpClass() throws Exception{
		...
		try {
			fio = new FileInputStream("sample/simpleCondition3.xml");
	...
	public void testSelectObject() throws Exception{
		...
		Object result = Jdbc.getInstance().dynamicSelectObject("select3", rMapper, user);
