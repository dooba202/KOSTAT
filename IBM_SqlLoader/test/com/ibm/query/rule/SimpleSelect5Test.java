...
public class SimpleSelect5Test {
	...
	public static void setUpClass() throws Exception{
		...
		try {
			fio = new FileInputStream("sample/simpleCondition5.xml");
	...
	public void testSelectObject1() throws Exception{
		...
		Object result = Jdbc.getInstance().dynamicSelectObject("select5", rMapper, user);
