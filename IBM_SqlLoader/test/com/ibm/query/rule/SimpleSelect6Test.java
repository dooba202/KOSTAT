...
public class SimpleSelect6Test {
	...
	public static void setUpClass() throws Exception{
		...
		try {
			fio = new FileInputStream("sample/simpleCondition6.xml");
	...
	public void testSelectObject1() throws Exception{
		...
		Object result = Jdbc.getInstance().dynamicSelectObject("select6", rMapper, user);
