...
public class SimpleSelect2Test {
	...
	public static void setUpClass() throws Exception{
		...
		try {
			fio = new FileInputStream("sample/simpleCondition2.xml");
	...
	public void testSelectObject() throws Exception{
		...
		Object result = Jdbc.getInstance().dynamicSelectObject("select2", rMapper, user);
