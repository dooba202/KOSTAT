...
public class IsSameSelectTest {
	...
	public static void setUpClass() throws Exception{
		...
		try {
			fio = new FileInputStream("sample/IsSameCondition.xml");
	...
	public void testSelectObject1() throws Exception{
		...
		Object result = Jdbc.getInstance().dynamicSelectObject("select1", rMapper, user);
