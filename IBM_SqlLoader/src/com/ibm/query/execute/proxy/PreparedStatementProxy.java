...
import com.ibm.query.execute.log.QueryWriter;

public class PreparedStatementProxy implements PreparedStatement, IHasQueryData {
	...
	public PreparedStatementProxy(String sql, PreparedStatement preparedStatement) {
		super();
		this.sql = sql;
